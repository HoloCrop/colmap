...
class GraphSolver {
 public:
   ...
   * @param SensorFromRigLogScale_num_max the maximum number of
   * SensorFromRigLogScales
   ...
   * @param ConstPinholeSensorCalibration_num_max the maximum number of
   * ConstPinholeSensorCalibrations
   ...
   * @param fixed_rig_log_scale_prior_num_max the maximum number of
   * fixed_rig_log_scale_priors
   * @param row_fixed_rig_pinhole_num_max the maximum number of
   * row_fixed_rig_pinholes
  ...
  GraphSolver(
      ...
      size_t SensorFromRigLogScale_num_max,
      ...
      size_t ConstPinholeSensorCalibration_num_max,
      ...
      size_t fixed_rig_log_scale_prior_num_max,
      size_t row_fixed_rig_pinhole_num_max,
  ...
  /**
   * Set the current value for the SensorFromRigLogScale nodes from the stacked
   * host data.
   *
   * The offset can be used to start writing at a specific index.
   */
  void SetSensorFromRigLogScaleNodesFromStackedHost(const double* const data,
                                                    size_t offset,
                                                    size_t num);
   ...
   * The offset can be used to start writing at a specific index.
   */
  void SetSensorFromRigLogScaleNodesFromStackedDevice(const double* const data,
                                                      size_t offset,
                                                      size_t num);

  /**
   * Read the current value for the SensorFromRigLogScale nodes into the stacked
   * output host data.
   *
   * The offset can be used to start reading from a specific index.
   */
  void GetSensorFromRigLogScaleNodesToStackedHost(double* const data,
                                                  size_t offset,
                                                  size_t num);
   ...
   * The offset can be used to start reading from a specific index.
   */
  void GetSensorFromRigLogScaleNodesToStackedDevice(double* const data,
                                                    size_t offset,
                                                    size_t num);

  /**
   * Set the current number of active nodes of type SensorFromRigLogScale.
   *
   * The value is set during initialization and this function is only needed if
   * you want to change the problem between optimization runs. This is work in
   * progress and can have performance impacts.
   */
  void SetSensorFromRigLogScaleNum(size_t num);
  ...
  /**
   * Set the indices for the pose argument for the FixedRigPinhole factor from
   * host.
   */
  void SetFixedRigPinholePoseIndicesFromHost(const unsigned int* const indices,
                                             size_t num);
   ...
   * device.
   */
  void SetFixedRigPinholePoseIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * FixedRigPinhole factor from host.
   */
  void SetFixedRigPinholeSensorFromRigLogScaleIndicesFromHost(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * FixedRigPinhole factor from device.
   */
  void SetFixedRigPinholeSensorFromRigLogScaleIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the point argument for the FixedRigPinhole factor from
   * host.
   */
  void SetFixedRigPinholePointIndicesFromHost(const unsigned int* const indices,
                                              size_t num);
   ...
   * device.
   */
  void SetFixedRigPinholePointIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the values for the sensor_from_rig consts FixedRigPinhole factor from
   * stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholeSensorFromRigDataFromStackedHost(
      const double* const data, size_t offset, size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholeSensorFromRigDataFromStackedDevice(
      const double* const data, size_t offset, size_t num);

  /**
   * Set the values for the calib consts FixedRigPinhole factor from stacked
   * host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholeCalibDataFromStackedHost(const double* const data,
                                                  size_t offset,
                                                  size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholeCalibDataFromStackedDevice(const double* const data,
                                                    size_t offset,
                                                    size_t num);

  /**
   * Set the values for the pixel consts FixedRigPinhole factor from stacked
   * host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholePixelDataFromStackedHost(const double* const data,
                                                  size_t offset,
                                                  size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPinholePixelDataFromStackedDevice(const double* const data,
                                                    size_t offset,
                                                    size_t num);
   ...
   * progress and can have performance impacts.
   */
  void SetFixedRigPinholeNum(size_t num);

  /**
   * Set the indices for the pose argument for the FixedRigPositionPrior factor
   * from host.
   */
  void SetFixedRigPositionPriorPoseIndicesFromHost(
      const unsigned int* const indices, size_t num);
   ...
   * from device.
   */
  void SetFixedRigPositionPriorPoseIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the values for the position consts FixedRigPositionPrior factor from
   * stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPositionPriorPositionDataFromStackedHost(
      const double* const data, size_t offset, size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPositionPriorPositionDataFromStackedDevice(
      const double* const data, size_t offset, size_t num);

  /**
   * Set the values for the sqrt_information consts FixedRigPositionPrior factor
   * from stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPositionPriorSqrtInformationDataFromStackedHost(
      const double* const data, size_t offset, size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigPositionPriorSqrtInformationDataFromStackedDevice(
      const double* const data, size_t offset, size_t num);
  ...
  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * FixedRigLogScalePrior factor from host.
   */
  void SetFixedRigLogScalePriorSensorFromRigLogScaleIndicesFromHost(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * FixedRigLogScalePrior factor from device.
   */
  void SetFixedRigLogScalePriorSensorFromRigLogScaleIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the values for the target consts FixedRigLogScalePrior factor from
   * stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigLogScalePriorTargetDataFromStackedHost(
      const double* const data);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigLogScalePriorTargetDataFromStackedDevice(
      const double* const data);

  /**
   * Set the values for the sqrt_information consts FixedRigLogScalePrior factor
   * from stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigLogScalePriorSqrtInformationDataFromStackedHost(
      const double* const data);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetFixedRigLogScalePriorSqrtInformationDataFromStackedDevice(
      const double* const data);

  /**
   * Set the current number of FixedRigLogScalePrior factors.
   *
   * The value is set during initialization and this function is only needed if
   * you want to change the problem between optimization runs. This is work in
   * progress and can have performance impacts.
   */
  void SetFixedRigLogScalePriorNum(size_t num);

  /**
   * Set the indices for the pose argument for the RowFixedRigPinhole factor
   * from host.
   */
  void SetRowFixedRigPinholePoseIndicesFromHost(
      const unsigned int* const indices, size_t num);
   ...
   * from device.
   */
  void SetRowFixedRigPinholePoseIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * RowFixedRigPinhole factor from host.
   */
  void SetRowFixedRigPinholeSensorFromRigLogScaleIndicesFromHost(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the sensor_from_rig_log_scale argument for the
   * RowFixedRigPinhole factor from device.
   */
  void SetRowFixedRigPinholeSensorFromRigLogScaleIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the indices for the point argument for the RowFixedRigPinhole factor
   * from host.
   */
  void SetRowFixedRigPinholePointIndicesFromHost(
      const unsigned int* const indices, size_t num);
   ...
   * from device.
   */
  void SetRowFixedRigPinholePointIndicesFromDevice(
      const unsigned int* const indices, size_t num);

  /**
   * Set the values for the sensor_calibration consts RowFixedRigPinhole factor
   * from stacked host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetRowFixedRigPinholeSensorCalibrationDataFromStackedHost(
      const double* const data, size_t offset, size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetRowFixedRigPinholeSensorCalibrationDataFromStackedDevice(
      const double* const data, size_t offset, size_t num);

  void SetRowFixedRigPinholeSensorCalibrationIndicesFromHost(
      const unsigned int* const indices, size_t num);
  void SetRowFixedRigPinholeSensorCalibrationIndicesFromDevice(
      const unsigned int* const indices, size_t num);
  /**
   * Set the values for the pixel consts RowFixedRigPinhole factor from stacked
   * host data.
   *
   * The offset can be used to start writing from a specific index.
   */
  void SetRowFixedRigPinholePixelDataFromStackedHost(const double* const data,
                                                     size_t offset,
                                                     size_t num);
   ...
   * The offset can be used to start writing from a specific index.
   */
  void SetRowFixedRigPinholePixelDataFromStackedDevice(const double* const data,
                                                       size_t offset,
                                                       size_t num);
   ...
   * progress and can have performance impacts.
   */
  void SetRowFixedRigPinholeNum(size_t num);
 ...
 private:
  ...
  size_t SensorFromRigLogScale_num_;
  size_t SensorFromRigLogScale_num_max_;
  ...
  size_t ConstPinholeSensorCalibration_num_;
  size_t ConstPinholeSensorCalibration_num_max_;
  ...
  size_t fixed_rig_log_scale_prior_num_;
  size_t fixed_rig_log_scale_prior_num_max_;
  size_t row_fixed_rig_pinhole_num_;
  size_t row_fixed_rig_pinhole_num_max_;
  ...
  double* nodes__SensorFromRigLogScale__storage_current_;
  double* nodes__SensorFromRigLogScale__storage_check_;
  double* nodes__SensorFromRigLogScale__storage_new_best_;
  ...
  SharedIndex* facs__fixed_rig_pinhole__args__pose__idx_shared_;
  double* facs__fixed_rig_pinhole__args__sensor_from_rig__data_;
  SharedIndex*
      facs__fixed_rig_pinhole__args__sensor_from_rig_log_scale__idx_shared_;
  double* facs__fixed_rig_pinhole__args__calib__data_;
  SharedIndex* facs__fixed_rig_pinhole__args__point__idx_shared_;
  double* facs__fixed_rig_pinhole__args__pixel__data_;
  double* facs__fixed_rig_pinhole__args__reprojection_loss_scale__data_;
  ...
  double* facs__fixed_rig_position_prior__args__position_loss_scale__data_;
  ...
  SharedIndex*
      facs__fixed_rig_log_scale_prior__args__sensor_from_rig_log_scale__idx_shared_;
  double* facs__fixed_rig_log_scale_prior__args__target__data_;
  double* facs__fixed_rig_log_scale_prior__args__sqrt_information__data_;
  SharedIndex* facs__row_fixed_rig_pinhole__args__pose__idx_shared_;
  double* facs__row_fixed_rig_pinhole__args__sensor_calibration__data_;
  SharedIndex*
      facs__row_fixed_rig_pinhole__args__sensor_calibration__idx_shared_;
  SharedIndex*
  ...
  double* facs__row_fixed_rig_pinhole__args__pixel__data_;
  double* facs__row_fixed_rig_pinhole__args__reprojection_loss_scale__data_;
  ...
  double* facs__fixed_camera_pinhole_point__args__pixel__data_;
  SharedIndex*
  ...
  double* facs__fixed_rig_log_scale_prior__res_;
  double* facs__row_fixed_rig_pinhole__res_;
  ...
  double* facs__fixed_rig_pinhole__args__pose__jac_;
  ...
  double*
      facs__fixed_rig_log_scale_prior__args__sensor_from_rig_log_scale__jac_;
  double* facs__row_fixed_rig_pinhole__args__pose__jac_;
  double* facs__row_fixed_rig_pinhole__args__sensor_from_rig_log_scale__jac_;
  double* facs__row_fixed_rig_pinhole__args__point__jac_;
  ...
  double* nodes__SensorFromRigLogScale__z_;
  double* nodes__SensorFromRigLogScale__z_end__;
  ...
  double* nodes__SensorFromRigLogScale__p_;
  double* nodes__SensorFromRigLogScale__p_end__;
  ...
  double* nodes__SensorFromRigLogScale__step_;
  double* nodes__SensorFromRigLogScale__step_end__;
  ...
  double* nodes__SensorFromRigLogScale__w_;
  ...
  double* nodes__SensorFromRigLogScale__r_0_;
  ...
  double* nodes__SensorFromRigLogScale__r_k_;
  ...
  double* nodes__SensorFromRigLogScale__Mp_;
  ...
  double* nodes__SensorFromRigLogScale__precond_diag_;
  double* nodes__SensorFromRigLogScale__precond_tril_;
  ...
  double* facs__fixed_rig_log_scale_prior__jp_;
  double* facs__row_fixed_rig_pinhole__jp_;
...
#ifndef CASPAR_USE_DOUBLE
  enum class RigSchurMode { STANDARD, FIXED_RIG, ROW_FIXED_RIG };
  std::unique_ptr<RigSchurSolver> rig_schur_solver_;
  RigSchurMode rig_schur_mode_ = RigSchurMode::STANDARD;
#endif
};
